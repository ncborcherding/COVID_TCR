...
seuratObj$TCRA.COVID[grepl("SARS-CoV-2", seuratObj$TRA_Epitope.species)] <- "Yes"
...
seuratObj$TCRB.COVID[grepl("SARS-CoV-2", seuratObj$TRB_Epitope.species)] <- "Yes"
...
pheatmap::pheatmap(t(summary[,2:56]))
dev.off()
```